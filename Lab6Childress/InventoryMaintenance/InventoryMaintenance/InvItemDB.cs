...
{
    public class InvItemDB : InvItem
    {
       
        public static new int ItemNo = itemNo;
        public static new string Description = description;
        public static new decimal Price = price;
        ...
        public static List<InvItem> GetItems()
        {
            ...
            if (xmlIn.ReadToDescendant("Item"))
            {
                ...
                do
                {
                    ...
                    if (type == "Plant")
                    {
                        Plant p = new Plant(ItemNo,Description,Price);
                        ReadBase(xmlIn, p);
                    ...
                    {
                        Supply s = new Supply(ItemNo, Description, Price);
                        ReadBase(xmlIn, s);
